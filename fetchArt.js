...
// API proxy and serializer for ANO_Art layer
...
/*
    ...
    art_dekning ( type: esriFieldTypeDouble, alias: art_dekning )
...
const fetchArt = async () => {
    const baseUrl =
        'https://arcgis06.miljodirektoratet.no/arcgis/rest/services/naturovervaking/ano/MapServer/11/query?'
